        ...
        child: Row(
          children: [
            ButtonColumn(
              ...
              button5Text: "10^x",
              isScientific: true,
              button1Method: () => Calculation.operandClick("1"),
              button2Method: () => Calculation.operandClick("1"),
              button3Method: () => Calculation.operandClick("1"),
              button4Method: () => Calculation.operandClick("1"),
              button5Method: () => Calculation.operandClick("1"),
            ),
            // const ButtonColumn(
            //   button1Text: "sin",
            //   button2Text: "cos",
